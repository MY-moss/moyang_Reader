...
- [ ] **用户反馈：更新入口“更多”工作流与不中断阅读**：启动前已重新核验无重复产品 PR；当前主线为 `main@8325982f12276e938084523966f02404ba2db041`，独立工作树/分支 `codex/update-more-workflow-2026-09-03`；修复已有更新状态被重复检查销毁、下载完成强制重启和更多面板未及时收起；本地完整质量门禁已通过，待创建唯一 PR。只做这一垂直切片，默认首页/旧 M 图标、#191 剩余读屏另行拆分。
