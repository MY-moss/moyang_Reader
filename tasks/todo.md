...
- [ ] **#366 统一确认弹层与未保存修改语义**：从合并后的 `main@45334c0b6cf9dc5f9b1bd39d2803b96181f0643e` 创建项目内工作树；清空全部草稿改用应用弹层，关闭确认增加真实草稿留存文案和“保存并退出”；补组件测试、浏览器 E2E、Windows 关闭路径和交接文档，完成一个 PR 后停止。
