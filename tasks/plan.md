...
- [ ] **F-06 #370 阅读历史与本地统计（当前切片：步骤 3/3）**：步骤 1/2 已合并最近文档时间语义和本机前台可见性心跳；本轮补齐本地周一至周日统计、去重文档数、累计时长和清理确认入口；仅本机、无联网/匿名上报、不引入图表库；T1/T2。PR [#422](https://github.com/MY-moss/moyang_Reader/pull/422) 待远程门禁合并后收口 Issue。
