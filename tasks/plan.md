...
- [x] **F-07f #191 焦点模式 Escape 互斥（本切片）**：专注模式/命令面板等嵌套交互只由最内层 Escape 关闭并正确归还焦点；不与读屏播报切片合并；T2。分支 `codex/escape-mutex-2026-09-03`，PR [#432](https://github.com/MY-moss/moyang_Reader/pull/432)，待合并后关闭 Issue #191。
