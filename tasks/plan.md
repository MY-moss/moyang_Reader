...
- [ ] **F-07 #191 键盘与读屏细节（当前子切片）**：第 1 个子切片让快速打开高亮跟随方向键/鼠标并保持 `aria-activedescendant` 与可视区同步；剩余树导航、目录高亮、读屏播报和焦点归还继续拆分；不引入新 UI 框架；T2。PR [#424](https://github.com/MY-moss/moyang_Reader/pull/424) 等待远程门禁。
