...
- [ ] **F-07 #191 键盘与读屏细节（当前子切片）**：快速打开、标签栏两个子切片已合并；当前第 3 个子切片为文件树 roving tabindex、上下/Home/End 和文件夹 Left/Right 导航；目录高亮、读屏播报和焦点归还继续拆分；不引入新 UI 框架；T2。当前分支 `codex/file-tree-roving-2026-09-02`，PR 待创建。
