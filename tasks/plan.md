...
- [x] **F-09g1 #171 CSS 字体字号令牌治理第三批（本切片）**：顶栏、更多/设置、查找栏、标签栏、左侧阅读库操作与文件条目、阅读历史摘要、状态栏使用 `--type-*` 令牌收敛 9–19px 字号；保持当前计算值和布局行为，不改业务语义；T2；分支 `codex/css-font-token-2026-09-03`，PR [#436](https://github.com/MY-moss/moyang_Reader/pull/436) 已创建，当前远端提交 `2f7c6f5e61e4624328e2aea78f332f2df6b3f7b5`，合并后补主线 SHA 与 Quality checks。
