...
- [ ] **F-09b 用户反馈：更新入口“更多”工作流与不中断阅读**：更新按钮固定在“更多”操作栏；已有更新、下载中和已安装状态可恢复查看，下载完成不自动重启；不改更新端点、签名和发布资产；T3；分支 `codex/update-more-workflow-2026-09-03`，PR [#429](https://github.com/MY-moss/moyang_Reader/pull/429) 已创建，Quality checks run `33677345042` 排队中。
