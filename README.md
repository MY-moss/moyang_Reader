...
v0.8.0 快速功能批次已完成 v0.7–v0.8 计划中的主要基础能力，继续保持 Windows 优先、本地优先和轻量启动：
...
`src-tauri/target/release/bundle/nsis/Moyang Reader_0.8.0_x64-setup.exe`
...
1. v0.8.0：当前基础功能批次，覆盖大文档、恢复中心、持久化索引、导出、无障碍、适配器、迁移备份、更新恢复和跨平台前置。
2. v0.9：继续迁移完整中英文文案、补充真实 Tauri 桌面 E2E 和更多格式适配器。
3. v1.0：在核心功能和跨平台发布稳定后，再评估同步生态、受控扩展能力与长期兼容性承诺。
