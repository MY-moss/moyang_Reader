...
v0.10.3 已发布；v0.10.4 发布候选已完成工作区新建笔记/文件夹、空文件夹显示和文件树/正文右键菜单，待 Windows x64 资产验证；保持本地优先和轻量启动：
...
6. v0.10.4：发布候选包含工作区新建笔记/文件夹、文件树/正文右键菜单，待稳定资产核验。
7. v0.10：嵌入、块引用、属性和关系图筛选。
7. v0.11：Worker/分批导出、PDF/Word 模板和分享体验。
8. v0.12：Windows 镜像巡检、更新器回归和发布稳定性。
9. v1.0：Windows x64 核心能力冻结，进入长期维护。
