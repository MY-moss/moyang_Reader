...
- 当前主线基线：`main@556a6fa98c7a5afd69aa88d4d2167ce5a90f6f8b`；PR #384、#385、#386、#388、#389、#390、#391、#392、#395 已合并，Issue #360、#359、#361、#362、#367、#369 已以 `completed` 关闭。
...
- 当前唯一下一项：#368 文档书签第一切片；详细 READY 契约见 [`NEXT.md`](NEXT.md)，完成后停止，不自动开启下一项。
...
- 状态：Ready 候选；Should / P2；T2；计划 `v0.11.x`；Issue：[#368](https://github.com/MY-moss/moyang_Reader/issues/368)。
...
- 验收：添加/列出/跳转/删除闭环；标题锚点和失效文档状态可解释；刷新后状态保留；Escape、焦点、未保存保护、目录和反向链接不回归；至少一条浏览器 E2E。实现前重新检查 Issues/PR，并从最新 `main` 建项目内 worktree。
