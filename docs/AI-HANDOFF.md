...
- 当前主线基线：`main@d93c992474db0e5e8ab0f04d68044db1ab774700`；PR #384、#385、#386、#388、#389、#390、#391、#392、#395、#396、#397、#398、#399、#401、#402 已合并，Issue #360、#359、#361、#362、#367、#368、#369、#372 已以 `completed` 关闭。
- 最新完成切片：PR #402 完成 #372 设置备份 v2——阅读位置和书签随便携设置恢复；保持 Windows x64、本地优先和 Markdown 真源边界。
...
- 当前状态：#372 已由 PR #402 squash 合并，详细契约和交接以 [`NEXT.md`](NEXT.md) 为准；本轮已完成并停止。
...
7. #371：中文拼音搜索候选；#372：设置导出/导入补全阅读位置与书签（已完成，PR #402）。
