...
| v0.10.4 | 发布候选：工作区新建笔记/文件夹、空目录持久显示、文件夹/根目录右键菜单，以及 Markdown/TXT 编辑上下文菜单、标签页中键关闭/拖拽排序和连续阅读缩放；版本文件已同步，待 tag、Release 和 Windows x64 资产验证                                                                                                  | #232、用户反馈                                                  |
