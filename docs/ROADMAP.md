...
| v0.10.4 | 开发中：工作区新建笔记/文件夹、空目录持久显示、文件夹/根目录右键菜单，以及 Markdown/TXT 编辑上下文菜单；完成 Windows 桌面回归后发布安装包                                                                                                                          | #232、用户反馈                                                  |
