...
- 稳定基线：`v0.10.13`；本切片开始时远程主线为 `main@28bf09d88f3eb379897c31adbdeda5ef426b2adc`，PR #377 已完成 #357，PR #380 已完成 #358，PR #379 与 PR #381 已完成构建缓存稳定性补强，PR #384 已完成 #360，PR #386 已完成 #369，PR #388 已完成 #359，PR #390 已完成 #361；#362 正在本切片完成。
...
| 17   | #362     | 交互与渲染微成本包（实现完成，待 PR）      | 拖动预览延迟提交、草稿解析复用、差异 memo；定向/全量单测和浏览器回归通过          |

## #362 交互与渲染微成本包（实现完成，待 PR）
...
- 发布/回滚：不单独生成安装包、Tag、Release 或镜像，合入后纳入 `v0.11.0` Windows x64 稳定批次；回退本切片 PR，无数据迁移。
