...
| v0.10.5 | 发布候选：文件/文件夹右键打开、重命名、删除、资源管理器定位、路径复制；重命名/删除后的标签与最近记录同步；Markdown/TXT 编辑菜单补齐撤销、重做、剪切、复制、粘贴、全选；Windows 授权和路径安全校验                                                                  | #232、用户反馈                                                  |
