...
| v0.9.2  | 渲染异常恢复边界；阅读/WYSIWYG/HTML 导出的 h4 层级与列表节奏；顶栏菜单外点/Esc 关闭；桌面 watcher/refresh 扩展（新增/删除）、导出写盘、应用内关闭确认、更新提示与外部修改安全；补齐 PDF 文件落盘和更新器桌面回归                                                   | #174、#188、#231、#88、#178、#192                               |
