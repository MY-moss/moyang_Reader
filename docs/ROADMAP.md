...
- 发布：这是用户可见的 v0.10.7 patch 候选；PR Quality checks、Windows 桌面定向回归和发布检查通过后，生成 Windows x64 安装包、签名、manifest 并核验 GitHub/Cloudflare 资产。
