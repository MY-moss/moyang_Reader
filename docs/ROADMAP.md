...
| v0.10.3 | 发布准备：首次使用教程、设置保存状态和 Windows 应用配置文件兜底已由 PR #272 合并；待发布 Windows x64 patch 安装包并验证更新链路                                                                                                                                    | 用户反馈、设置持久化                                            |
